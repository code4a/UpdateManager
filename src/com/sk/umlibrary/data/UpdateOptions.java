package com.sk.umlibrary.data;

import com.sk.umlibrary.R;
...
public final class UpdateOptions {
    ...
    public boolean shouldCheckUpdate() {
        ...
        String PREFS_NAME = context.getResources().getString(
                R.string.preference_name);
        String PREFS_KEY_NEXT_CHECK_UPDATE_TIME = context.getResources()
                .getString(R.string.preference_key_next_check_update_time);
    ...
    public static class Builder {
        private UpdatePeriod updatePeriod = new UpdatePeriod(
                UpdatePeriod.EACH_TIME);
        ...
        /**
         * if new app is available, and the forceupdate is true,then the user
         * must upgrade, otherwise the app is not available.
         *
         * @return Builder
         */
        ...
        /**
         * Should the client check for update? You do not need call it
         * Generally.
         *
         * @return
         */
        ...
        /**
         * Whether check the package name. if true,then the package name of the
         * local app should be the same as new app.if not set,true default.
         *
