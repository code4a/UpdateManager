...
import com.sk.umlibrary.concurrent.AsyncTask;
import com.sk.umlibrary.dao.AbstractUpdateListener;
import com.sk.umlibrary.dao.impl.DefaultUpdateListener;
import com.sk.umlibrary.dao.impl.UpdateJsonParser;
import com.sk.umlibrary.dao.impl.UpdateXmlParser;
import com.sk.umlibrary.data.UpdateOptions;
import com.sk.umlibrary.data.UpdatePeriod;
import com.sk.umlibrary.downloader.DownloadListener;
import com.sk.umlibrary.downloader.DownloadManager;
import com.sk.umlibrary.downloader.DownloadTask;
import com.sk.umlibrary.exception.UpdateException;
import com.sk.umlibrary.net.HttpRequest;
...
public class UpdateManager {
     ...
     */
    public static final int MSG_SHOW_NO_UPDATE_UI = 2;
    /**
     * There is no need to update.
     */
    public static final int MSG_SHOW_UPDATE_UI = 3;
    /**
     * There is no need to update.
     */
    public static final int MSG_SHOW_UPDATE_PROGRESS_UI = 4;

    /**
     * click to update
     */
    public static final int MSG_INFORM_UPDATE = 10;
    /**
     * click to cancel the update
     */
    public static final int MSG_INFORM_CANCEL = 11;
    /**
     * click to skip the update
     */
    public static final int MSG_INFORM_SKIP = 12;
    /**
     * error occurs
     */
