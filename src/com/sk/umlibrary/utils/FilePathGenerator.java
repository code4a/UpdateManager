package com.sk.umlibrary.utils;
...
public abstract class FilePathGenerator {
    ...
    protected String dir = "/mnt/sdcard/hi-github/android/log";
    ...
    public static class DefaultFilePathGenerator extends FilePathGenerator {
         ...
         * @param suffix
         */
        public DefaultFilePathGenerator(Context context, String filename,
                String suffix) {
         ...
         * @param suffix
         */
        public DefaultFilePathGenerator(String dir, String filename,
                String suffix) {
    ...
    public static class DateFilePathGenerator extends FilePathGenerator {
         ...
         * @param suffix
         */
        public DateFilePathGenerator(Context context, String filename,
                String suffix) {
            super(context, filename, suffix);
    ...
    public static class LimitSizeFilePathGenerator extends FilePathGenerator {
         ...
         * @param maxSize
         */
        public LimitSizeFilePathGenerator(Context context, String filename,
                String suffix, int maxSize) {
            super(context, filename, suffix);
         ...
         * @param maxSize
         */
        public LimitSizeFilePathGenerator(String dir, String filename,
                String suffix, int maxSize) {
            super(dir, filename, suffix);
            this.maxSize = maxSize;
        }
