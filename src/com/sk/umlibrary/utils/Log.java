...
public class Log {
     ...
     * @param thr
     */
    protected static void log2Console(LEVEL level, String tag, String msg,
            Throwable thr) {
        switch (level) {
        case VERBOSE:
            if (thr == null) {
     ...
     * @param tr
     */
    private static void log2File(LEVEL level, String tag, String msg,
            Throwable tr) {
        if (generator == null) {
        ...
        if (!isFilter) {
            Log2File.log2file(generator.getPath(),
                    formatter.format(level, tag, msg, tr));
        }
    }
    ...
    public static void setPath(String path) {
        generator = new FilePathGenerator.DefaultFilePathGenerator(path, null,
                null);
    }
    ...
    public enum LEVEL {
        VERBOSE(2, "V"), DEBUG(3, "D"), INFO(4, "I"), WARN(5, "W"), ERROR(6,
                "E"), ASSERT(7, "A");
